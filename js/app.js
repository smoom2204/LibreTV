// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["tyyszy","zy360","wolong","jisu","bfzy","mozhua","mdzyapi","ruyi","iKun","zuida"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["tyyszy","zy360","wolong","jisu","bfzy","mozhua","mdzyapi","ruyi","iKun","zuida"];
